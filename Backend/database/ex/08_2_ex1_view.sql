...
-- 		SELCET문
-- 	;
-- 	** [OR REPLACE] : 기존의 뷰가 있을 경우 덮어쓰기employees


SELECT emp.emp_no, CONCAT(emp.last_name, ' ', emp.first_name) FULL_NAME, tit.title, tit.to_date
FROM employees emp
